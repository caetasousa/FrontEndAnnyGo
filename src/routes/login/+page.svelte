    ...
    >
        ...
        <div class="w-full max-w-md mx-auto px-8 py-12">
            ...
            <form class="space-y-5">
                ...
                <div class="pt-2">
                    <button
                        class="w-full flex justify-center items-center py-3 px-4 border border-transparent rounded-lg shadow-md text-sm font-semibold text-white bg-primary hover:bg-primary-hover focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary transition-all duration-200 transform active:scale-[0.98]"
                        type="button"
                    >
                        Acessar Conta
                        <span class="material-icons text-sm ml-2"
                            >arrow_forward</span
                        >
                    </button>
                </div>
            ...
            >
                <p class="mb-3">
                    © 2023 BellaVita Salon. Todos os direitos reservados.
                </p>
                <div class="space-x-4">
                    <a
