          ...
          >
            <div>
              ...
              <p class="text-gray-500 dark:text-gray-400 mt-1">
                Conheça os especialistas prontos para cuidar de você.
              </p>
            </div>
        ...
        {#if filteredProviders.length === 0}
          ...
          >
            ...
            <p class="text-gray-500">
              Nenhum profissional encontrado para "{searchQuery}" {statusFilter !==
              "todos"
                ? `(${statusFilter})`
                : ""}
            </p>
              ...
              >
                <div class="p-6 flex flex-col items-center text-center">
                  <div class="relative mb-4">
                    ...
                    />
                    <span
                      class="absolute bottom-1 right-1 w-5 h-5 rounded-full border-2 border-white dark:border-gray-800 {provider.status ===
                      'disponivel'
                        ? 'bg-green-500'
                ...
                >
                  <div class="flex items-center gap-2">
                    ...
                    <span class="text-xs text-gray-400 uppercase tracking-wider"
                      >{provider.ativo ? "Ativo" : "Inativo"} • {provider.status}</span
                    >
                  </div>
                  <a
                    href="/prestadores/{provider.id}"
                    class="px-4 py-2 bg-brand-orange/10 text-brand-orange hover:bg-brand-orange hover:text-white rounded-md text-sm font-semibold transition-all"
                  >
                    Ver Perfil
                  </a>
                </div>
