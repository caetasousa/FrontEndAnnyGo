            ...
            <div class="max-w-6xl mx-auto space-y-6">
                ...
                >
                    ...
                    <div class="grid grid-cols-7 gap-2 text-center">
                        <div
                            class="p-2 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 cursor-pointer"
                        >
                            <p class="text-xs text-gray-500 uppercase">Seg</p>
                            <p
                                class="text-sm font-medium mt-1 text-gray-900 dark:text-white"
                            >
                                23
                            </p>
                        </div>
                        <div
                            class="p-2 rounded-lg bg-primary text-white shadow-md cursor-pointer"
                        >
                            <p class="text-xs text-white/80 uppercase">Ter</p>
                            <p class="text-sm font-bold mt-1">24</p>
                        </div>
                        <div
                            class="p-2 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 cursor-pointer"
                        >
                            <p class="text-xs text-gray-500 uppercase">Qua</p>
                            <p
                                class="text-sm font-medium mt-1 text-gray-900 dark:text-white"
                            >
                                25
                        ...
                        <div
                            class="p-2 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 cursor-pointer"
                        >
                            <p class="text-xs text-gray-500 uppercase">Qui</p>
                            <p
                                class="text-sm font-medium mt-1 text-gray-900 dark:text-white"
                            >
                                26
                        ...
                        <div
                            class="p-2 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 cursor-pointer text-gray-400"
                        >
                            <p class="text-xs uppercase">Sab</p>
                            <p class="text-sm font-medium mt-1">28</p>
                        </div>
                        <div
                            class="p-2 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 cursor-pointer text-gray-400"
                        >
                            <p class="text-xs uppercase">Dom</p>
                            <p class="text-sm font-medium mt-1">29</p>
                        </div>
                    </div>
                </div>
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <div class="lg:col-span-2 space-y-4">
                        ...
                        <div
                            class="bg-[hsl(var(--bs-card))] rounded-lg shadow-sm border-l-4 border-l-success border-y border-r border-gray-200 dark:border-gray-700 p-4 transition-all hover:shadow-md"
                        >
                            <div
                                class="flex flex-col sm:flex-row justify-between items-start sm:items-center"
                            >
                        ...
                        <div
                            class="bg-gray-50 dark:bg-[hsl(var(--bs-muted))]/20 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4 opacity-75"
                        >
                            <div
                                class="flex flex-col sm:flex-row justify-between items-start sm:items-center"
                            >
                                ...
                                >
                                    <div
                                        class="bg-gray-200 dark:bg-gray-700 text-gray-500 p-2 rounded-full"
                                    >
                                        <span class="material-symbols-outlined"
                                            >done_all</span
                                        >
                                    ...
                                    <div>
                                        <div class="flex items-center">
                                            ...
                                            >
                                            <span
                                                class="text-sm text-gray-500 dark:text-gray-400 font-medium line-through"
                                                >Design de Sobrancelhas</span
                                            >
                                            <span
                                                class="ml-2 text-xs bg-gray-200 dark:bg-gray-700 text-gray-600 dark:text-gray-300 px-2 py-0.5 rounded-full"
                                                >Concluído</span
                                            >
                                        </div>
                                        <p
                                            class="text-sm text-gray-500 dark:text-gray-400 mt-1"
                                        >
                                            Cliente: <span class="font-medium"
                                                >Carla Dias</span
                                            >
                                        </p>
                                    </div>
